...
<Link to="/dashboard?tab=BMI">
      <button className='ml-[-100px]'>check BmI</button>
      </Link>
      <Link to="/feed">
      <button className='ml-[100px]'>Feedback</button>
      </Link>
      <Link to="/Feedpage">
      <button className='ml-[100px]'>All Feedback</button>
      </Link>
